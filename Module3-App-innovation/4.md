...
1. Notice that you have received a adaptive card request sent by workflow on the **SAP on Azure-<inject key="DeploymentID" />** teams channel about the approval to add new product.
