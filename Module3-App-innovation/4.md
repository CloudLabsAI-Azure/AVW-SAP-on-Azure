...
1. Notice that workflow has sent a adaptive card request to the temas chat named **Flow** asking yor for the approval to add new product to the catalog.
...
1. Now,  you will receive another adaptive card asking yor for the approval of request to add second product to the catalog.
