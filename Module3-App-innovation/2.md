...
In this task, you will review the model which you created and trained in the previous task. You will also test the model manually to observe the behaviour of it.
