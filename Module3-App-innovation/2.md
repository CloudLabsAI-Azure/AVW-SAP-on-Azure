...
1. Leave table name as default (Table 1) and enter the column name as `Product ID`.
...
1. On the **Table 1** blade, select the box which is under **Name** to tag name value from the table which is inside the document.
