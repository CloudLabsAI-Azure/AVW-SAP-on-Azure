...
In this task, you will review the pre-built and trained model which extracts the data from the documents using AI Builder from the Power Apps portal and also test the model manually to observe its behavior.
