...
1. Now, under **Refine a model for your business needs**, select **Form Processing** model.
   ...
   ![](../media/M3-Ex1-AIbuilder-2-1.png)
...
1. On the **Select source** blade, select **Upload from local storage** to add the files that are available in the Virtual Machine.
