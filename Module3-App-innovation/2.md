...
1. Now, under **Try out AI capabilities for each data type**, scroll down and select the **Extract custom information from documents** model.
   ...
   ![](../media/M3-Ex1-AIbuilder-2-2.png)
...
4. Click on the **Form Processing (1)** model to rename it, then provide a name for the model as <inject key="AIModelName" /> **(2)** and click on **Rename (3)** to create the model.
