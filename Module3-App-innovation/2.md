...
1. Select **AI Builder (1)** from the left-hand side menu and click on **Build (2)** to build a new model.
   ...
   > On the **Enhance your business with AI** blade, you can find the built-in models. Scroll and review the available models.
...
1. On the **Getting Started** blade of the Form Processing model, provide a name for the model as <inject key="AIModelName" /> **(1)** and click on **Create (2)** to create the model.
...
1. Now, enter the column name as `Description` and click on **+** to add a new column to **Table 1**.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-AIbuilder-7.1.png?raw=true)

1. Next, enter the column name as `Name` and click on **+** to add a new column to **Table 1**.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-AIbuilder-7.2.png?raw=true)

1. Now, enter the column name as `Pricing` and click on **+** to add a new column to **Table 1**.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-AIbuilder-7.3.png?raw=true)
...
1. On the **Model Summary** blade, review the model details and click on **Train** to train the model.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-AIbuilder0-43.png?raw=true)
...
1. From the model's page, under the model **ProductExtraction-<inject key="DeploymentID" />**, click on **Publish** under **Training document** to publish the model.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-AIbuilder-47.png?raw=true)
