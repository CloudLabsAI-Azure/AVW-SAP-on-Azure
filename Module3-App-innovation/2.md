...
1. Select **AI Builder (1)** from the left-hand side menu and click on **Build (2)** to build a new model.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-AIbuilder-1.1.png?raw=true)
...
1. Now, under **Refine a model for your business needs**, select **Form Processing** model.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-AIbuilder-2.1.png?raw=true)
...
1. On the **Add** blade, select **Single page table (preview) (1)** from the left-hand side menu and click on **Next (2)**.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-AIbuilder-3.2.1.png?raw=true)

1. On the **Single page table (preview)** blade, leave the table name as default (Table 1) and click on **column1**.
...
1. Click on **+** to add a new row to the table **Table 1** and repeat steps 28-42 to add the second row.
