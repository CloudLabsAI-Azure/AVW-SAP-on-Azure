...
1. Click on the **Menu** icon which is at the top left corner of the Power Automate home page.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex3-powerautomate-1.png?raw=true)
   
1. Select **Sign in** option from the list to sign in to the Power automate Portal.
...
1. On the **Process and save information from forms** action blade, enter the following information.
    ...
    3. Form: Perform the below steps to provide **Attachments Content** as value.
          ...
          1. Search for **Attachments Content** and select it from the dynamic content list.
...
1. Next, follow the below instructions to provide value for the **x-ms-cookie-header** field.
      ...
      1. Enter `replace(outputs('List_product_sets')['headers']['Set-Cookie'],',',';')` in the expression box.
