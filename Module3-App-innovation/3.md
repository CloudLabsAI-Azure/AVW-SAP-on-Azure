...
1. On the **Process and save information from forms** action blade, enter the following information.
      ...
      3. Form: Perform the below steps to provide **Attachments Content** as value.
           ...
           1. Click inside the edit box of **Select a form to process** so that the dynamic content list appears on the right side of the designer.  
 ...
 1. Now, perform the below steps to add value to the **Body** field.
      ...
      1. Enter the below content:
       ...
       1. Follow the below instructions to add the parameters:
           ...
           1. Select the **Table 1 Product ID value** parameter under **Process and save information from forms** from the dynamic content list.
