...
1. Perform the below steps to provide a value for **Name** field.
...
1. Follow the below instructions to provide value for **Supplier ID** field.
...
1. For **Currency Code** field, select **European Euro** from the dropdown.

1. Perform the below steps to provide value for **Price** field.
...
1. Follow the below instructions to provide value for **Description** field.
