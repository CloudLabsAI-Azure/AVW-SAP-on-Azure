 ...
 1. Now, perform the below steps to add value to the **Body** field.
      ...
      1. Enter the below content:
       ...
       1. Follow the below instructions to add the parameters:
           ...
           1. Click enter after the line **Approval request has been received for the following product:** to add the parameters.
...
1. For the Team field, select **SAP on Azure-<inject key="DeploymentID" />** from the dropdown.
