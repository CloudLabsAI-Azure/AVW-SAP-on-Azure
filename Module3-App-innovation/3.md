...
1.  On the **When a new mail arrives (V3)** trigger blade, enter the following information:
     ...
     1. Folder: Leave **Inbox** value as default.
...
1. On the **Process and save information from forms** action blade, enter the following information.
    ...
    1. Form type : Select **PDF Document** from the dropdown.

       ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-13.2.png?raw=true)

    3. Form: Perform the below steps to provide **Attachments Content** as value.
...
1. After adding all the actions and triggers, your screen will look like the below screenshot.
