...
1. Under actions, scroll down and select **Post an adaptive card to a Teams user and wait for a response** action.
   ...
   > You will configure the **Post an adaptive card to a Teams user and wait for a response** action in the following steps.
    ...
    1. Post in : Select **Chat with Flow bot** from the dropdown.
    
    1. Update a message: Enter **Thanks for the Message**.
...
1. After adding all the actions and triggers, your workflow will look like this:
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-53.1.png?raw=true)
