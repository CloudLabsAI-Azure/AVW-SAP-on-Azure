...
## Task 1.2: Add Apply to each control to the flow
...
## Task 1.3: Add AI Builder Action to the flow

In this task, you will add **Process and save information from forms** action to the flow to process the data from the document attached in the mail.
...
1. For **AI model** field, select **ProductExtraction-<inject key="DeploymentID" />** model from the dropdown.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-13.1.png?raw=true)

1. Select **PDF Document** from the dropdown for **Form type** field.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-13.2.png?raw=true)
...
1. For **Form** fields, perform the below steps to provide **Attachments Content** as value.
      ...
      1. Click inside the edit box of **Form** so that the dynamic content list appears on the right side of the designer.  
         ...
         ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-13.3.png?raw=true)
...
## Task 1.4: Add Apply to each control to the flow
...
## Task 1.5: Add Send an email Action to the flow
...
1. Follow the below instructions to add the parameters the **Body** field:
     ...
     1. Select the **Table 1 Product ID value** parameter under **Process and save information from forms** from the dynamic content list and click enter.

        ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-30.png?raw=true) 

     1. Click inside the edit box of **Body** so that the dynamic content list appears on the right side of the designer.  
     1. Select the **Table 1 Name value** parameter under **Process and save information from forms** from the dynamic content list and click enter.

        ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-24.png?raw=true) 

     1. Click inside the edit box of **Body** so that the dynamic content list appears on the right side of the designer.  
     1. Select the **Table 1 Pricing value** parameter under **Process and save information from forms** from the dynamic content list.

        ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-26.png?raw=true) 

         > You added the parameters **Table 1 Product ID value**, **Table 1 Name value**, and **Table 1 Pricing value** of **Process and save information from forms** into the body so that data will be fetched and added along with the message. 

1. After adding all parameters, the final screenshot will look like this:

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-30.1.png?raw=true) 
...
## Task 1.6: Add Post an adaptive card to a Teams user and wait for a response Action to the flow
...
1. Under actions, scroll down and select **Post an adaptive card and wait for a response** action.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow0-33.png?raw=true) 

1. After selecting the action, select the following select the following information.

1. In **Post as** section, Select **Flow bot**.

1. In **Post in** section, select **Chat with Flow bot**.
    
   > You will configure the **Post an adaptive card and wait for a response** action in the following steps.
...
1. Provide the below username value in the **Recipient** field.
...
## Task 1.7: Add Condition Control to the flow
...
1. Select **Add an action** to add a new action to **Apply to each** control.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow0-8.2.png?raw=true)
...
1. Now, select inside the **Choose a value** box which is at the left side of **is equal to** box so that the dynamic content list appears on the right side of the designer and performs the below steps.
     ...
     1. Enter the below value in the expression box.
        ...
        ``` 
        ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow0-40.png?raw=true) 
...
## Task 1.8: Add List Product Sets Action to the flow
...
## Task 1.9: Add Add Apply to each control to the flow
...
## Task 1.10: Add List Product Sets Action to the flow
...
1. Perform the below steps to provide value for the **x-csrf-token** field.
      ...
      1. Select the **x-csrf-token** token under **GET Product** from the dynamic content list.
...
1. Now, perform the below steps to provide value for the **Product ID** field.
      ...
      1. Scroll down on the dynamic content list and Select **Product ID** parameter under **Process and save information from forms**.

         ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-52.png?raw=true) 

1. For the **Type Code** field, select **Product** from the dropdown.

1. Select **Tablets** from the dropdown for the **Category** field.
...
1. After adding all the actions and triggers, your workflow will look like this:
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-53.png?raw=true)
