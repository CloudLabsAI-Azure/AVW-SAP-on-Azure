...
1. Click on **Untitled** to rename the flow and provide the name for the flow as **CreateSAPProductFromEmail**.
...
## Task 1.2.1: Add AI Builder Action to the flow
...
## Task 1.2.2: Add Apply to each control to the flow
...
1. Sselect **Add an action** to add a new action to **Apply to each** control.
...
## Task 1.2.3: Add Send an email Action to the flow
...
## Task 1.2.4: Add Post an adaptive card to a Teams user and wait for a response Action to the flow
...
1. Under actions, scroll down and select **Post an adaptive card to a Teams user and wait for a response (Preview)** action.
   ...
   > Info: You will configure the **Post an adaptive card to a Teams user and wait for a response (Preview)** action in the following steps.
...
## Task 1.2.5: Add Condition Control to the flow
...
1. After adding all the values, your screen will look like the below screenshot.
   ...
   > Info: Next, you will be configuring the actions that are to be taken if the condition is true.

## Task 1.2.6: Add List Product Sets Action to the flow
...
## Task 1.2.7: Add Add Apply to each control to the flow
...
## Task 1.2.8: Add List Product Sets Action to the flow
