...
1. Enter the below content in the **Body** field.
    ...
    > Now we need to add the parameters **Table 1 Product ID value**, **Table 1 Name value**, and **Table 1 Pricing value** of **Process and save information from forms** into the body so that data will be fetched and added along with the message. 
