...
1. To add **Apply to each** control, enter the following information:
   ...
   3. Under **Search connectors and triggers**, select **All** tab. 
   4. Search for **AI Builder** and select it from the list.

      ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-12.png?raw=true)

   6. Under **Actions**, select **Process and save information from forms** to embed an action into the **Apply to each** control.

      ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-13.png?raw=true)

   8. On the **Process and save information from forms** action blade, enter the following information.
   ...
   3. Under **Actions**, select **GET Product** action from the list.

      ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-17.png?raw=true)

   5. On the **GET Product** action blade, enter the following information.
        - id: Enter `MC-CM-1001`
   ...
   6. Now, select **Add an action** to add a new action.
   7. Under **Search connectors and triggers**, select **All** tab. 
   8. Search for **Control** and select it from the list.
   ...
   1. To add **Apply to each** control, enter the following information:
       ...
       3. Under **Actions**, select **Add Product** action from the list.

          ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-21.png?raw=true)

       3. On the **Add Product** action balde, enter the following information.
