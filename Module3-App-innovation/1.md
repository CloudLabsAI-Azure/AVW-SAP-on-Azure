...
1. Select **Data** from the left-hand side menu.
   ...
   ![](https://github.com/Kalyani7744/AVW-SAP-on-Azure/blob/main/media/SAPmod3-task01-04.png?raw=true)

1. Now, to create a custom connector select **Custom Connectors** from the dropdown list.

   ![](https://github.com/Kalyani7744/AVW-SAP-on-Azure/blob/main/media/SAPmod3-task01-03.png?raw=true)

1. You will be presented with the custom connectors page, click on **+New custom connector** to create a new customer.

   ![](https://github.com/Kalyani7744/AVW-SAP-on-Azure/blob/main/media/SAPmod3-task01-02.png?raw=true)

1. Select **Import from Github** from the list to import the connector from **Github**.

   ![](https://github.com/Kalyani7744/AVW-SAP-on-Azure/blob/main/media/SAPmod3-task01-01.png?raw=true)
