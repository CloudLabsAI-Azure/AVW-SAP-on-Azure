   ...
   1. To add **Apply to each** control, enter the following information:
       ...
       3. On the **Add Product** action balde, enter the following information.
            ...
            1. Supplier ID: Perform the below steps to select **Supplier ID** from the dynamic content list.
                 ...
                 2. Search for and select **Supplier ID** parameter under **GET Product** from the dynamic content list.
            ...
            1. Description: Perform the below steps to select **Table 1 Description value** from the dynamic content list.
                 ...
                 2. Search for and select **Table 1 Description value** parameter under **Proccess and save information from forms** from the dynamic content list.
