...
Contoso uses SAP Systems to store information related to products they provide. Currently, the process to add a new product into the catalogue is by first sending the Product Information to the Manager over email for approval. Once approved, the product details are entered into the catalogue via SAP Fiori Web Application.

Contoso wants you to innovate and transform their manual business processes to digital, automated processes.

To accomplish this, you will use Power Apps, Power Automate and transform Contoso.
...
In this exercise, you will create a Power App which will be used to connect to your SAP System and then create business flows and workflows to add the product into the catalogue.

Here are the tasks you will be performing:
  ...
  * Task 3: Create Flow to automate the process
  * Task 4: Verify the workflow

## Task 1: Create Power App and add Custom Connector to connect to SAP System
