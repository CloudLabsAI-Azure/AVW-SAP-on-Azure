...
1. To add **Apply to each** control, enter the following information:
     ...
     1. To add **Apply to each** control, enter the following information:
         ...
         1. Now, enter the following information to configure the **Post an adaptive card to a Teams channel and wait for a response (Preview)** action.
             ...
             3. Message: Click in the message box and enter the following content.
                ...
                "body": [
                 ...
                 ```
             4. After adding the content, notice that there are few values that are to be replaced in the content with values from the dynamic content list. 
         ...
         1. Next, we will be configuring the actions that are to be taken if condition is true. Select **Add an action** under **If Yes** to add a new action.   
...
1. Now, open the mail that is being triggered by the flow and review it.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-powerapps-43.png?raw=true)
...
1. Click on **Approve** on the **Add new product request** message to approve the request for adding the first product.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-powerapps-44.png?raw=true)

1. On the second **Add new product request** message, click on **Reject** to reject the request.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-powerapps-45.png?raw=true)

   >  After approving/rejecting the request, you will receive a confirmation message which is being sent by the flow.

1. Navigate back to the browser tab in which Power automate portal was open. If you have closed the tab, you can navigate to this URL `https://flow.microsoft.com/en-us/` to open the Power automate portal.
...
1. Select **My Flows** from the left-hand side menu and select the **CreateSAPProductromEmail** flow you created in the previous task.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-powerapps-46.png?raw=true)
...
1. On the **CreateSAPProductromEmail** flow blade, notice that flow has been triggered. You can find the triggered flow on the **28-day run history** tile.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-powerapps-47.png?raw=true)
 
1. Select the most recent run and review the progress of the workflow.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-powerapps-51.png?raw=true)

1. Wait until the run status changes to **Succeeded**, then open the flow and review it.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-powerapps-48.png?raw=true)

1. Return to the browser tab in which SAP developer system was open. If you have closed the tab you can navigate to the below URL to open the  SAP developer system.
...
1. Then, click on the **Manage Products** tile and you will be redirected to a new view.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-powerapps-50.png?raw=true)
