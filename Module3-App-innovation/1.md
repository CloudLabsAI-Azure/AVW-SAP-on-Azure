...
1. On the **Getting Started** blade of Form Proceesing model, provide name for the model as **ProductExtraction-<inject key="DeploymentID" />** and click on **Create** to create the model.
