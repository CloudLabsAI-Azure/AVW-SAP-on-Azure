...
1. Select **Dataverse** from the left-hand side menu.
   ...
   ![](https://github.com/Shivashant25/AVW-SAP-on-Azure/blob/main/media/m3e3t1s2.png?raw=true)

1. Now, to create a custom connector select **Custom Connectors** from the dropdown list.

   ![](https://github.com/Shivashant25/AVW-SAP-on-Azure/blob/main/media/m3e1t1s3.png?raw=true)

1. You will be presented with the custom connectors page, click on **+New custom connector** to create a new customer.

   ![](https://github.com/Shivashant25/AVW-SAP-on-Azure/blob/main/media/m3e1t1s4.png?raw=true)

1. Select **Import from Github** from the list to import the connector from **Github**.

   ![](https://github.com/Shivashant25/AVW-SAP-on-Azure/blob/main/media/m3e1t1s5.png?raw=true)
