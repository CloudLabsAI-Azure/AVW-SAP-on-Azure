     ...
     1. To add **Apply to each** control, enter the following information:
         ...
         1. On the **Add Product** action blade, enter the following information.
              ...
              1. x-ms-cookie-header : To add an expression as value, follow the below steps:
                  ...
                  - Enter `replace(outputs('http_get_request')['headers']['Set-cookie'], ',', ';')` in the expression box.
...
1. Now, you will sending an email which includes the document to the user account which you added while configuring the **When a new mail arrives** trigger, so that new mail arrives in the inbox and workflow will be triggered.
