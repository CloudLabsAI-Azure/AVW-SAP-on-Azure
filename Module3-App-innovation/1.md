...
1. Select the **Contoso-Product-07** pdf file from the list and review the content in the file.
   ...
   > Now, you will send an email which includes the document to the user account which you added while configuring the **When a new mail arrives** trigger, so that new mail arrives in the inbox and workflow will be triggered.
