     ...
     1. To add **Apply to each** control, enter the following information:
         ...
         1. On the **Add Product** action blade, enter the following information.
              1. x-csrf-token: Perform the below steps to select the x-csrf-token token from the dynamic content list.
                  ...
                  2. Select **x-csrf-token** token under **GET Product** from the dynamic content list.
              ...
              1. Product ID: Perform the below steps to select **Product ID **from the dynamic content list.
                  1. Click inside the edit box of **x-csrf-token** so that the dynamic content list appears.  
                  2. Scroll down on the dynamic content list and Select **Product ID** parameter under **GET Product**.
              ...
              1. Name: Perform the below steps to select **Table 1 Name value** from the dynamic content list.
                  ...
                  2. Search for and select **Table 1 Name value** parameter under **Process and save information from forms** from the dynamic content list.
              ...
              1. Supplier ID: Perform the below steps to select **Supplier ID** from the dynamic content list.
                  ...
                  2. Search for and select the **Supplier ID** parameter under **GET Product** from the dynamic content list.
              ...
              1. Price: Perform the below steps to select **Table 1 Pricing value** from the dynamic content list.
                  ...
                  2. Search for and select **Table 1 Pricing value** parameter under **Process and save information from forms** from the dynamic content list.
              ...
              1. Description: Perform the below steps to select **Table 1 Description value** from the dynamic content list.
                  ...
                  2. Search for and select **Table 1 Description value** parameter under **Process and save information from forms** from the dynamic content list.
