...
1. Select **+New App (1)** and then select **Canvas (2)** from the dropdown.
   ...
   > You will be redirected to a new page to create a canvas app. If you are presented with **Welcome to Power Apps Studio** pop-up, click on **Skip** to skip the tour.
...
1. Now, select **Connectors** from the list to view and add the **SAP-ODATA-Demo (2)** connector to the app.
