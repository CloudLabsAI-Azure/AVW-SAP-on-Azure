...
In this task, you will create connections in Power Automate and use them in next task while building workflow.
...
1. Now, select the **Sign in** option form the list to sign in to the Power automate Portal.
...
1. You will be presented with the below page that provides information about the package and its related resources.
...
1. On the **Import setup** blade, enter the following information and select **Save**.
      ...
      1. **Setup**: Select **Create as new** from the dropdown.
...
1. On the **Import setup** blade, select the **Microsoft Teams** connection that you created in the previous task and click on **Save**.
...
1. On the **Import setup** blade, select the **SAP-ODATA-Demo** connection that you created in the previous task and click on **Save**.
...
1. Once the flow is imported, you will be presented with the below page. Click on **Open flow** to open the flow.
...
1. Select **More (1)** option and then click on **Turn on (2)** to make the flow available to use.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-025.png?raw=true)   

## Summary

In this exercise, you have imported a workflow in the Power Automate that which will process the information using an AI model, send the Product Information to the Manager over email for approval and add products to the catalog once the request is approved.   
