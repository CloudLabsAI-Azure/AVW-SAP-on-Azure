...
1. You will be presented with the custom connectors page, click on **+New connection** to create a new connection.

1. Now, search for **Office 365 Outlook** using the search bar available at the top right corner and select it.

1. On the **Office 365 Outlook** pop-up, click on **Create** then use the below credentials to complete the **Sign-in** process and create the connection.
...
1. Now, search for **Microsoft Dataverse** using the search bar available at the top right corner and select it.

1. On the **Microsoft Dataverse** pop-up, click on **Create** then use the below credentials to complete the **Sign-in** process and create the connection.

1. Click on **+New connection** to create a new connection.

1. Now, search for **Microsoft Teams** using the search bar available at the top right corner and select it.

1. On the **Microsoft Teams** pop-up, click on **Create** then use the below credentials to complete the **Sign-in** process and create the connection.
...
1. Within the Virtual Machine, navigate to this path C:\LabFiles\Products and select the **CreateSAPProductFromEmail.zip** file and click on open to choose the file.
...
1. Then, click on **Select during import** that is next to **SAP-ODATA-Demo** connector under **Related resources** to select the connector.
...
1. Select **more ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-Ex1-flow-023.png?raw=true)** option and then click on **Turn on** to make the flow available to use.
