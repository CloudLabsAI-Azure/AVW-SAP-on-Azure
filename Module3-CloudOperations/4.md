...
In this exercise, you will review the pre-deployed Recovery Services vault that is being used to store the recovery points that are created over time. You will then review the pre-created private endpoints that are required for performing the backup. Then, you will review the SAP HANA databases that are being backed up to the recovery service vault running on an Azure Virtual Machine. You will also review the SAP HANA database that are being restored from the recovery service vault.
...
In this task, you will create a Recovery Services vault to store the recovery points that are created over time.
...
In this task, you will create and use private endpoints to securely back up and restore your data from the Recovery Service vault.
...
1. In the above steps you have reviewed the databases that are backed up, you can follow the below instructions to configure backup for the discovered databases running on SAP HANA Virtual Machine.    
   ...
   > **Note**: Below instructions are read-only, as the databases running on the SAP HANA Virtual Machine are already backed up to the recovery service vault in the provided lab environment.
...
In this task, you will review the status and details of restore jobs that restore the SAP HANA databases running on an Azure Virtual Machine from the Recovery Services vault.
...
1. On the **Restore** blade, review the details of the job.
  ...
  > **Note**: Below instructions are read-only, you will not be able to restore the databases running on the SAP HANA VM from the recovery service vault because they have already been restored in the provided lab environment.
1. Select **Backup items** under **Protected items** from the left-hand side menu of the recovery service vault.
