...
1. Review the listed databases that are backed up to the recovery service vault and their status on the **Backup Items (SAP HANA in Azure VM)** blade.
    ...
    ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-p2-Ex4-backup-36.1.png?raw=true)
...
1. Select the database on the **Backup Items (SAP HANA in Azure VM)** blade.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-p2-Ex4-backup-25.1.png?raw=true)
