...
Azure Backup is Backint certified by SAP, certified by SAP, to provide native backup support by leveraging SAP HANA’s native APIs. This offering from Azure Backup aligns with Azure Backup’s model of zero-infrastructure backups, eliminating the need to deploy and manage backup infrastructure. SAP HANA databases can now seamlessly backup and restore running on Azure VMs (M series VMs also supported now!) and leverage enterprise management capabilities that Azure Backup provides.
...
1. In the above steps you have reviewed the pre-deployed recovery service vault, you can follow the below instructions to create a new recovery service vault.
...
1. In the above steps you have reviewed the pre-deployed private endpoint, you can follow the below instructions to create a new private endpoint.   
...
1. In the above steps you have reviewed the databases that are backed up, you can follow the below instructions to configure backup for the discovered databases running on SAP HANA Virtual Machine.    
