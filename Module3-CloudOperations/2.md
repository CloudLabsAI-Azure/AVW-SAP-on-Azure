...
1. In the above steps you have reviewed the pre-deployed **Azure Monitor for SAP Solutions** resource, you can find the instructions below  to create a new **Azure Monitor for SAP Solutions** resource.
   ...
   > **Note**: Below instructions are read-only, as the provided lab environment doesn't have the required permissions to create the Azure Monitor for SAP Solution resource.
...
1. Navigate back to **SAPHANARG** resource group and select the key vault named **SAPHANAKeyvaultS0** from the list of resources.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-p2-Ex2-resources-3.png?raw=true)

1. On the **Overview** blade of **SAPHANAKeyvaultS0** resource, review the information about the key vault.
...
1. On the **SAPHANADBPassword** secret blade, select the version of the secret that is listed under the **CURRENT VERSION** section.
...
1. In the above steps you have reviewed the pre-deployed key vault, you can find the instructions below to create a new key vault.
   ...
   > **Note**: Below instructions are read-only, as the provided lab environment doesn't have the required permissions to create a new key vault.   
...
1. In the above steps you have reviewed the pre-configured **SAPHANAProvider**, you can find the instructions below to create add a new SAP HANA provider.
   ...
   > **Note**: Below instructions are read-only, as the provided lab environment doesn't have the required permissions to create a new SAP HANA provider.      
