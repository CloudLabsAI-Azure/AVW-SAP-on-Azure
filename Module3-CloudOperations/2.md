...
1. Navigate back to the browser tab in which Azure Portal is open and select **SAPHANARG** resource group from the list.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-p2-Ex2-resources-1.png?raw=true)

1. Select the **Azure Monitor for SAP Solutions** resource named **SAPMonitor**.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-p2-Ex2-resources-2.png?raw=true)
...
1. Navigate back to **SAPHANARG** resource group and select the key vault named **SAPHANAKeyvault** from the list of resources.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-p2-Ex2-resources-3.png?raw=true)
...
1. Select the **SAP HANA** link on the Providers blade to open it.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-p2-Ex2-saphanaprovider-23.png?raw=true)
...
1. On the **SAP HANA System Availability** blade, review the information about the alert rule and select the condition that is listed and the **Condition** section.
