...
1. Leave other values as defualt and click on **Create alert rule** to create the rule.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M3-p2-Ex3-alert-27.png?raw=true)

1. Once the alert rule is created, click on **X** to close the **Create alert rule** blade.
