...
1. Select the drop down that is next to **No grouping**(1) and then select **Group by Smart groups (preview)**(2) to review the alerts that are grouped.

   ![](../media/monitor-smart-groups-latest.png)
