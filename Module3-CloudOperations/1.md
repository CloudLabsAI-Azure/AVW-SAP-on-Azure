...
In this exercise, you will log in to the Azure Portal and review the pre-deployed resources. You will also connect to the SAP HANA database and verify the status of the database.
