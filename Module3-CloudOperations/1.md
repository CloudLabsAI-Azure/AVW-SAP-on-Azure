...
The pre-deployed SAP HANA solution comes as a standard S/4HANA system installation including a remote desktop for easy frontend access. It contains a pre-configured and activated SAP S/4HANA Fiori UI is generally used as the front end in client 100, with prerequisite components activated in the solution.
