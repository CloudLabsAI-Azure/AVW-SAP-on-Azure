...
1. Review the available resources and select the virtual machine named **saphanademo-SAP2**.

1. From the overview blade, copy the **Public IP address** of the virtual machine that will be used to connect to the database.
