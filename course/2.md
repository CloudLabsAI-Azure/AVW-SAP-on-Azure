# HOL 1: Cloud Operations, Governance, Security

# Exercise 2: Azure Backup for SAP  
...
In this task, you will enable managed identities for the recovery service vault that allows it to create and use private endpoints that are required for backup.
...
In this task, you will grant permissions to the vault to create the required private endpoints for Azure Backup.
