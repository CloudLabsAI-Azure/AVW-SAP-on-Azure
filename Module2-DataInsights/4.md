...
1. Repeat 6-11 steps again to add new **Http** step, but this time by providing the name **http_post_request**.
...
1. Under the **http_get_request** step, enter the following information:
   ...
   - Enter the following Header parameters:
    ...
    - **Body** : Enter the following content.
     ...
     - **Cookie** : To add an expression as value, follow the below steps:
...
- Review the logic app run and alerts triggered by logic app.
