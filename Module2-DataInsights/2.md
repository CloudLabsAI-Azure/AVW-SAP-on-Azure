...
* Login for an account in SAP and ES5
...
In this exercise, you have logged in to a SAP user account and an ES5 Demo Account to get access to the SAP Gateway demo system and reviewed the data in different datasets.
