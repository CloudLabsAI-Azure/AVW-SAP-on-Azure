...
1. On the **Finalize your account** blade, enter the following details:
    ...
    3. Check the box: I acknowledge that I have read the SAP Universal ID Terms of Use
    4. Click on **Submit**.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/m2ex2t1s13.png?raw=true)  
...
1. Then, click on **Manage Products** tile and you will be redirected to a new view. Please note you may see different number for manage product.
