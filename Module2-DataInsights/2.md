...
4. Now,  you will be redirected to a page that confirms the SAP Community user account is active. You can close the tab as SAP account is done. You can close the tab as SAP account setup is done.
