...
In this exercise, you will create a SAP Community user account and an ES5 Demo Account to get access to SAP Gateway demo system and review the data of sales order dataset.
