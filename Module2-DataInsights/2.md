...
In this exercise, you will create a SAP Community user account and an ES5 Demo Account to get access to the SAP Gateway demo system and review the data of the sales order dataset.
...
1. Within the provided vm, open a new tab and browse to the below URL to register for the SAP user Account.
...
1. Once you click on the user icon, you will be presented with the registration page.
...
1. You can see that the dataset returns all the different collections like ProductSet, SalesOrderSet. 

1. Now, navigate to the following URL to view the sales order dataset which you will later connect to and retrieve the informations.
