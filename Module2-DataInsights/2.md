...
In this task, you will access the Sample service GWSAMPLE_BASIC which contains a list of items of a sales order from the Enterprise Procurement demo, and review the data of the sales order dataset. 
