...
1. On the **One time registration for continuous access** tab, scroll down and provide the following information.
    ...
    - Confirm password : Enter <inject key="AzureAdUserPassword"></inject>
...
1. You will recieve an email as `notification@sapnetworkmail.com` from SAP to activate your account, open it to activate your account.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M2-Ex2-sapaccount-3.1.png?raw=true)
...
1. Then, you will be redirected to a page that confirms the SAP Community user account is active. You can close the tab as SAP account is done.
...
1. Once done, you will be directed to the **Legal Disclaimers for SAP Cloud Platform** page, check the box to accept **Terms and Conditions**.
...
1. Click on **Register** to register your ES5 Demo Account.
   ...
   > Info: As the registration is being processed, you will be presented with the below page which contains the **User Information**. 
 
     ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M2-Ex2-sapaccount-6.1.png?raw=true)
...
1. Since this is the first time you have logged in, you will be asked to reset the password. Enter the following information:
   ...
   - **New Password**: Enter <inject key="AzureAdUserPassword"></inject>
   - **Repeat Password** : Enter <inject key="AzureAdUserPassword"></inject>
