...
1. Within the Virtual Machine, open up a new tab on the web browser and navigate the below URL to register for the SAP user Account.
...
1. On the **One time registration for continuous access** tab, scroll down and provide the following information.
    ...
    - Confirm password : Enter this value <inject key="AzureAdUserPassword"></inject>
...
1. Once done, you will be directed to the **Legal Disclaimers for SAP Cloud Platform** page, click on **Accept** to accept the **Terms and Conditions**.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M2-Ex2-sapaccount-5.1.png?raw=true)   
