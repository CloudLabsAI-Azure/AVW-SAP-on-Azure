...
1. Now, click on **Sign in** which is at the top right corner and use the below credentials to complete **Sign in** process.

   * Email/Username: <inject key="AzureAdUserEmail"></inject>
   * Password: <inject key="AzureAdUserPassword"></inject>

1. On the **Stay Signed in to all you apps blade**, uncheck **Allow my organization to manage my device (1)** and click on **No, sign in to this app only (2)**.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M2-Ex5-Excel-1.2.png?raw=true)

3. Now, select the **Data (1)** tab from the menu and click on **Get Data (2)**.
