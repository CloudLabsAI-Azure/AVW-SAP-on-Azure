...
1. Return to the browser tab in which Azure Portal was open, if you have closed the tab, you can navigate to this url ```https://portal.azure.com``` to open Azure portal.
...
1. From the IoT hub **Overview** tab, scroll down and review the available options.
...
## In this exercise, you have covered the following:
   ...
   - Simulating the device using a Web simulator.
   - Reviewing the data being sent to Iot Hub in Web simulator.
   - Reviewing the telemetry data generated by the device in Azure Iot Explorer.
