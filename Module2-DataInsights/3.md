...
This exercise includes the following tasks:
  ...
  * Review the Service Bus queue and Shared access policy
...
In this task, you will review the device identity in the identity registry in your Azure IoT hub. A device cannot connect to a hub unless it has an entry in the identity registry. 
