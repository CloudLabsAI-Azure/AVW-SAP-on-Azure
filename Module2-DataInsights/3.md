...
Contoso has included the temperature sensors within the packages and wants to monitor the temperature of the packages. You need to configure the Azure IoT Hub Solution to receive telemetry and manage all the devices centrally in a reliable and scalable fashion. 
