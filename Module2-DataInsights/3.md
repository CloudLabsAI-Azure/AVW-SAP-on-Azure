...
3. Navigate to **aiw-sap-iothub-<inject key="DeploymentID" enableCopy="false" />** resource group and select the iothub named iothub-<inject key="DeploymentID" enableCopy="false" />.
...
1. From the IoT hub navigation menu Select **IoT Devices (1)** under **Explorers**, then select **+ New (2)** to add a device in your IoT hub.
   ...
   ![](https://github.com/Kalyani7744/AVW-SAP-on-Azure/blob/main/media/M2-Ex2-iothubdevice00.png?raw=true)
