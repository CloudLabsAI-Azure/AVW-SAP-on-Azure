...
In this exercise, you will review the existing Iot Hub and create an Iot Hub device. You will use the web simluator and configure it to connect to Iot Hub then simulate the device and view the sensor data that is being sent to Iot Hub. Using Azure IoT Explorer, you will also review the telmetry data sent by simulated device to Azure Iot Hub. 
...
In this task, you will you create an Iothub device for the existing Iothub .
...
In this task you will launch the Raspberry Pi online simulator and configure the existing code to connect to the Iothub.
 
1.  Within the JumpVM, navigate to the below URL to launch the Raspberry Pi online simulator.
...
In this task, you will use the Azure IoT Explorer to review the telemetry data sent by the simulated iothub device to Azure IoT Hub.
...
1. Navigate back to the browser tab in which Raspberry Pi online simulator was open and click on **Stop** to stop sending the data to IotHub.

## In this exercise, you have covered the following:
 
   - Creating an Iot Hub device.
   - Simulating the device using Web simulator.
   - Reviewing the data being sent to Iot Hub in Web simulator.
   - Reviewing the telemetry data genrated by device in Azure Iot Explorer.
