...
1. From the IoT hub navigation menu Select **IoT Devices (1)** under **Explorers**, then select **+ New (2)** to add a device in your IoT hub.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AVW-SAP-on-Azure/blob/main/media/M2-Ex2-iothubdevice-01.png?raw=true)
...
1. After the device is created, open the device **device01** from the IoT devices pane.
   ...
   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M2-Ex2-iothubdevice-2.1.png?raw=true)
   
   > **Note**: If you are not able the view the device on the IoT device pane, click on **Refresh** to fetch the recent results.

      ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M2-Ex2-iothubdevice-4.1.png?raw=true)
