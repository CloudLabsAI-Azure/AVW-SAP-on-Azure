...
1. You can find the iothub **Connection string** value at **IoTHubConnectionString** under **Environment Details** tab at the right of the workspace.

   ![](https://github.com/CloudLabsAI-Azure/AIW-SAP-on-Azure/blob/main/media/M2-Ex3-iotexplorer-1.png?raw=true)
   
1. Copy the **IoTHubConnectionString** value to notepad as you will need this value later.
