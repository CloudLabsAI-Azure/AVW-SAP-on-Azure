# Logic app for reference

You can either complete Task 1.1 and configure the Logic App to show SAP ERP data in Teams, or you can use the pre-configured Logic App and complete Task 1.2 to renew the authorization to Teams and Office365 and trigger the Logic App flow.
