...
1. Replace the existing name **HTTP** with the below name and select anywhere in the Logic App designer to save the name.
   ...
   > Info: In the following steps, you will configure the **http_get_request** action to login to the SAP Gateway system and fetch the appropriate token for use in the next action.
