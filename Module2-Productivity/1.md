...
1. Now to rename the step, select **ellipsis icon (1)** and then click on **Rename (2)**.
...
1. Once you click on **Run**, the logic app will be triggered and the will start its run.
...
1. Launch the **Microsoft Teams** application by clicking on Microsoft Teams shortcut on the virtual machine desktop.
