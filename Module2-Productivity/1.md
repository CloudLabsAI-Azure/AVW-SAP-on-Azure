...
In this exercise, you will configure a logic app to display the SAP ERP data in Teams and send an email regarding the SAP data to Outlook. Then, you will run the logic app and review the data triggered by the logic app in Teams and Outlook.
...
* Reviewed the generated e-mail regarding the SAP ERP data in Outlook.
