...
In this task, you will configure the pre-deployed Logic App to display the SAP ERP data in Teams and send an email of the SAP data to Outlook.
...
### Task 1: Review the pre-configured Logic App Flow 
