...
1. Now, click on **Titlebar** to close the recurrence trigger pane.
...
1. Click on eclipse **(1)** then click on Rename **(2)** and then namebox **(3)** and replace the existing name **HTTP** with the below name and select anywhere in the Logic App designer to save the name.

   ```
   http_get_request
   ```
   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T112S5.png?raw=true)
...
1. Select **Authentication** parameter from the dropdown then click in empty area to select it.
...
1. Now, click on **Titlebar** to close the HTTP action pane.

   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T112S13.png?raw=true)    
...
1. Click on **+ New Step** to add a new action.
   ...
   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T113S1.png?raw=true)
...
1. Now, click on **Titlebar** to close the Parse JSON action pane.

   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T113S10.png?raw=true)
...
1. Click on **+ New Step** to add a new action.
   ...
   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T114S1.png?raw=true)
...
1. Now, click on **Titlebar** to close the **Initialize variable** action pane.     

   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T114S7.png?raw=true)
...
1. Click on **+ New Step** to add a new action.
   ...
   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T115S1.png?raw=true)
...
1. Click on **Add an Action** to add a new action.

   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T115S6.png?raw=true)
...
1. Click on **Titlebar** to close the **Compose** action pane.

   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T115S12.png?raw=true)

1. Click on **Add an action** to the **For each** control.

   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T115S13.png?raw=true)
...
1. Click on **Titlebar** to close the **Append to array variable** action pane.
   
   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T115S20.png?raw=true)
   
1. Click on **Titlebar** to close the **For each** action pane.
   
   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T115S21.png?raw=true)
...
1. Click on **New step** to add a new action to the flow. 

   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T116S1.png?raw=true)
...
1. Click on **Titlebar** to close the **Create HTML table** action pane.

   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T116S8.png?raw=true)
...
1. Click on **New step** to add a new action to the flow. 
   ...
   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T117S1.png?raw=true)
...
1. Message: Enter `SAP with Azure!` and click enter. 
      ...
      - Now we need to add the **Output** of Create HTML Table into the Message box so that data will be posted in the teams along with the message. To do so, perform the below steps:
         ...
         3. Select **Output** which is under **Create HTML Table** from dynamic content list.
...
1. Click on **Titlebar** to close the **Post message in chat or channel** action pane.

   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T117S9.png?raw=true)
...
1. Click on **New step** to add a new action to the flow. 
   ...
   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T118S1.png?raw=true)
...
1. Click on **Titlebar** to close the **Send an email** action pane.

   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T118S10.png?raw=true)
...
1. Click on **Titlebar** to close the **Post a message (V3)** action pane.

   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T12S14.png?raw=true)
...
1. Click on **Titlebar** to close the **Send an email** action pane.
   ...
   ![](https://github.com/ShivaUdari/AVW-SAP-on-Azure/blob/main/media/M2E6T12S23.png?raw=true)
