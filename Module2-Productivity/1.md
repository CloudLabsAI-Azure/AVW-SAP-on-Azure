...
1. To add **For each** control, enter the following information:
   ...
   6. Under **Actions**, select **Compose** to embed a **Compose** action into the **For each** control.
   ...
   3. Under **Actions**, select **Append to array variable** action to add each record the variable ArraySalesOrder within the “For each” action.
...
1. Open the mail that is being triggered by the logic app and review the sales data.
