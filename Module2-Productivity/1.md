...
1. Enter the following information in the **Parse JSON** action: 
   ...
   1. Content:  To Add the **Body** output of the HTTP request, follow the below steps
...
1. Enter the following information to create append to array variable action:
      ...
      1. Name: Select **ArraySalesOrder** from the dropdown.
      2. Value: To add the Outputs of Compose as value, follow the below steps:
...
In this task, you will add **Post a message V(3) (Preview)** action to the flow to display the sales order data in Team's channel.
...
1. Select **SAP Channel** from the dropdown for **Channel** field.
...
1. Enter **SAP with Azure!** in the **Subject** field.
