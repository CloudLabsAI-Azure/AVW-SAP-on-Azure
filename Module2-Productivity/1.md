...
1. To establish the connection, navigate back to the **aiw-sap-<inject key="DeploymentID" />** resource group and select the API Connection named **teams**.
...
1. On the **Logic app designer** blade, Click on **Run Trigger** and click on **Run** to run the workflow.  

   ![](https://github.com/shashankms9/AVW-SAP-on-Azure/blob/788cdc2c3fb4f7fae10fca0a07ece047791acaa9/media/M2-EX6-T2-3.png)
