...
3. Navigate to **Source (1)** tab and observe the Source settings of the Pipeline.
    ...
    >Info : In this Pipeline **StaccID-IoTdata (2)** has been selected as the Source dataset where StaccID-IoTdata is an Integration dataset that stores data of  which are being fetched from the Storage account.
