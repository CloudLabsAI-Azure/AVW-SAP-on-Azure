...
1. Select the visualization of **Payments per SalesOrder by CustomerName** **(1)** and click on **Focus mode** **(2)**.
...
1. Select the visualization of **Sales per SalesOrderItem by PurchaseOrderbyCustomer** **(1)** and click on **Focus mode** **(2)**.
...
1. Select the visualization of **Sales per RequestedDeliveryDate by IoTData** **(1)** and click on **Focus mode** **(2)**.
...
1. Select the visualization of **Sales per CITYNAME by IoTData** **(1)** and click on **Focus mode** **(2)**.
