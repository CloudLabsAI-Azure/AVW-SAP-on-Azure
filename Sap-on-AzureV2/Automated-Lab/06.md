# Exercise 6: Import a workflow to export the PowerBI Sales report and Share it to Teams
...
In this exercise, you will establish connections for Power BI, One Drive for business, Approvals, Microsoft Teams, and Encodian in Power Automate. You will also import and trigger a flow to share the Power BI report to Teams. The workflow execution is described below.

  * Whenever you trigger the flow manually the flow will convert the Power BI report from PDF to PNG format.
  * In the next step, it will send an approval request to share the Power BI report to Teams.
  * You have to switch to the Approvals tab from the left-hand menu and click on **:heavy_check_mark:** to approve the request.
  * Once the request is approved, the flow will share the report to Mirosoft Teams.

This exercise includes the following tasks:

  * Create Connections in Power Automate
  * Import the workflow in Power Automate
  * Review the PowerBI report in teams
...
1. Enter your own details for the ask as shown in the below screenshot then click on **Submit** to activate the free trail account.
