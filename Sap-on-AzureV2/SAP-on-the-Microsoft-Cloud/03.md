...
1. Open the **File Explorer** **(1)** from the taskbar and navigate to `C:\PowerBI Reports` directory **(2)**. Double-click on the **SAP-IoT-Data** file to open the Power BI Report.
   ...
   >**Note:** PowerBI report might take 1-2 minutes to open. If it takes more time to open, close the PowerBI window and try to open the reports again.
...
In this task, you will publish the Power BI report to your workspace from the **PowerBI application**.

1. On the Power BI Desktop application, click on **Publish** which is present at the top right corner of the application.
...
1. Select **Workspaces** from the Power BI menu and click on the More button that is next to **My workspace**.
   ...
   ![](media/workspacenew.png)
   
1. Now, click on **Workspace settings**.

   ![](media/sap1.png)

1. On the **Workspace settings** blade, select **License mode** as **Premium capacity** and select the **License capacity** click on **Apply**.
...
In this exercise, you have  covered the following: 
 ...
 - Visualized the pre-built PowerBI reports in **PowerBI application** that are built against the **Sales Orders data, Payments, and IoT Hub device data**.
