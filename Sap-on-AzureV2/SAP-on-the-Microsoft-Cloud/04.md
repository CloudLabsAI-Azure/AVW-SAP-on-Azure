...
1. Take a look at the **Sales and Payment Forecast report** by **Year**. Select the Year **2020** **(1)** and review the **Sales at BillingDate** **(2)** by placing the cursor over it as shown in the below image.
...
In this exercise, you have visualized the pre-built PowerBI reports in **PowerBI application** that are built against the **Sales Orders Payments** data.
